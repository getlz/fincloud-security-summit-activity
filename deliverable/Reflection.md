...
## Technical Decisions
 ...
 I chose to simulate a key topic that was discussed in the event verifying requests before they reach an AI system
...
i also added a simple risk scoring mechanism to evaluate potentially dangerous input the decission was based on the idea that modern security systems do not trust any inputs by default 
and must continuously validate requests this method protects of possible vulnerabilities by employees.
...
and monitoring systems interact in a secure cloud environment. It doesnt go into detail alot but it shows the main idea and its easy to understand.
